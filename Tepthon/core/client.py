                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext = f"\nيتم تحميل هذا الملف فقط هنا ،\
                                  ...
                                  \n\nنحن نحترم خصوصيتك.\
                                  \n\nفقـط قـم بإعـادة توجيـه هـذه الرسـالة إلى مطـور السـورس @O_7_I\
                                  \n\n--------بـدء تتبـع سجـل تيبثـون 𝗠𝗼𝗵𝗮𝗺𝗺𝗮𝗱--------\
                        ...
                        ftext += "\n\n--------نهـاية سجـل تتبـع سـورس محمـد 𝗠𝗼𝗵𝗮𝗺𝗺𝗮𝗱--------"
                        ...
                        link = "[𝙈𝙊𝙃𝘼𝙈𝙈𝘼𝘿](https://t.me/O_7_I)"
                        text = (
                            "**✘ تتبـع سـورس محمـد 𝗠𝗼𝗵𝗮𝗺𝗺𝗮𝗱 ✘**\n\n"
            ...
            async def wrapper(check):
                try:
                    ...
                    if not disable_errors:
                        ...
                        text = "**✘ تتبـع سـورس محمـد 𝗠𝗼𝗵𝗮𝗺𝗺𝗮𝗱 ✘**\n\n "
                        link = "[𝙈𝙊𝙃𝘼𝙈𝙈𝘼𝘿](https://t.me/O_7_I)"
