...
ZelzalChecler_cmd = (
    ...
    "𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲 𝗠𝗼𝗵𝗮𝗺𝗺𝗮𝗱 - أوامـر الصيد والتشيكـر](t.me/A_S_Bl) 𓆪\n\n"
    ...
    "**⪼ لـ رؤيـة بعـض اليـوزرات التي قام بصيدهـا منصبيـن محمد**\n\n"
...
"𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲 𝗠𝗼𝗵𝗮𝗺𝗺𝗮𝗱 - أنـواع اليـوزرات](t.me/A_S_Bl) 𓆪\n\n"
        ...
        if replly and replly.text.startswith('@'): #Code Update by @zzzzl1l
            ...
            ch = await zedub(
                ...
                functions.channels.CreateChannelRequest(
                    ...
                    title="⎉ صيـد محمد 𝗠𝗼𝗵𝗮𝗺𝗺𝗮𝗱 ⎉",

                    about="This channel to hunt username by - @A_S_Bl ",
    ...
    try:
        ...
        ch = await zedub(
            ...
            functions.channels.CreateChannelRequest(
                ...
                title="⎉ تثبيت محمد 𝗠𝗼𝗵𝗮𝗺𝗺𝗮𝗱 ⎉",

                about="تم تثبيت اليـوزر بواسطـة سـورس محمد - @A_S_Bl ",
