...
ZED_TEXT = gvarstatus("CUSTOM_ALIVE_TEXT") or "•⎚• مـعلومـات المسـتخـدم مـن بـوت محمد"
ZEDM = gvarstatus("CUSTOM_ALIVE_EMOJI") or "✦ "
ZEDF = gvarstatus("CUSTOM_ALIVE_FONT") or "⋆─┄─┄─┄─ 𝗠𝗼𝗵𝗮𝗺𝗺𝗮𝗱 ─┄─┄─┄─⋆"
zed_dev = (6379161238, 71185337980, 63783798952)
zel_dev = (6379161238, 71186337980, 63753798952)
zelzal = (6379161238, 71186337980)
